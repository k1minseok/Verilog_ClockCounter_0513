...
#set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports { mode_sel[0] }]; #IO_L17N_T2_A13_D29_14 ,Sch=BTNU
...
#set_property -dict { PACKAGE_PIN U17  IOSTANDARD LVCMOS33 } [get_ports { mode_sel[1] }]; #IO_L18P_T2_A12_D28_14 ,Sch=BTND
